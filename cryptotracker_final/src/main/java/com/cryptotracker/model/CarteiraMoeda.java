...
public class CarteiraMoeda {
    ...
    public CarteiraMoeda(){} public CarteiraMoeda(Long carteiraId,Long moedaId,double quantidade){this.carteiraId=carteiraId;this.moedaId=moedaId;this.quantidade=quantidade;this.favorito=false;}
    ...
    public boolean isFavorito(){return favorito;} public void setFavorito(boolean favorito){this.favorito=favorito;}
}
